...
| Review Attention / R | 人应该优先看哪些源码关系与切片？ | Review Artifact / Attention Proposal | SourceSnapshot、Derivation Input runtime、Evidence Schema 0.1.1、Budget Primitive 与 Execution Cell 已冻结；后继 provenance runtime 尚未开始 |
...
| Review / R | 确定性源码事实、语义切片与未来注意力提案 | `R1_DERIVATION_EXECUTION_CELL_FROZEN / R1_DERIVATION_PROVENANCE_IMPLEMENTATION_NOT_STARTED / R1_RELATION_SLICE_COVERAGE_IMPLEMENTATION_NOT_STARTED` |
...
- Review Attention 已冻结 R0、首个 Pattern Corpus 与 R1 合同。R1 首版只针对 Python 3.10 结构语义，
  ...
  Execution Cell 才成为 frozen。后继只允许先审计 Provider Run 到 Fact admission 的 provenance 接缝，runtime
  尚未取得实现授权。
...
28. [Q0 最终冻结闭环](docs/119-q0-verification-scheduling-final-freeze-closure.md)
