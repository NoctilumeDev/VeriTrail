...
| `INVALID_INPUT` | `STARTER_VALIDATION_FAILED` | The explicit candidate violates Answers 0.1. |
...
| unknown output/version | `STARTER_VERSION_UNSUPPORTED` | Fail closed; the Skill knows only the frozen 0.1 protocol. |
