...
> 状态发布：`P0_FROZEN / P1_FROZEN / P2_FROZEN / P3_FROZEN / P4_NOT_STARTED`
>
...
> 发布见[文档 95](95-p3-core-handoff-freeze-publication.md)；P4 尚未开始。
...
P1 与 P2 Collector、P3 0.1 合同和 P3 实现均已冻结；P4 尚未开始。
