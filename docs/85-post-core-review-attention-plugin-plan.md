...
- 并行状态：`P1_FROZEN / P2_FROZEN / P3_CONTRACT_0.1_CANDIDATE / P3_IMPLEMENTATION_NOT_STARTED`；
...
4. R0 首次冻结事实继续保留当时的 `P1_FROZEN / P2_NOT_STARTED`；本文当前并行状态另行反映
   `P2_FROZEN / P3_CONTRACT_0.1_CANDIDATE / P3_IMPLEMENTATION_NOT_STARTED`，两者不得互相改写；
...
本文当前状态只更新并行事实为
`P2_FROZEN / P3_CONTRACT_0.1_CANDIDATE / P3_IMPLEMENTATION_NOT_STARTED`；它不把 R0 当时尚未发生的
P2 写回历史，也不因 P3 合同候选解除 R1 阻断。
