...
先前从 `main@9c58b7367712ae726b826b54115766b81444cdf1` 建立的候选 PR #68 在原始门禁中暴露既有
M11 CLI 聚合 `ERROR`，因此停止且未合入。PR #69 只增加失败层级诊断，并以原始 11/11 门禁合入
当前基线；该成功不覆盖 #68，也不把未复现解释为已知根因。本候选从新的 exact main 重新建立。
